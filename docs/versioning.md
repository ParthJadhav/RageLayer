...
Desktop Destroyer follows semantic versioning and uses Changesets to record release intent.
...
- `desktop-destroyer`
- `desktop-destroyer/react`
- `desktop-destroyer/vue`
- `desktop-destroyer/svelte`
- `desktop-destroyer/package.json`

Files under `src/`, generated chunk filenames under `dist/`, DOM nodes/classes beginning with `dd-`,
...
Every user-visible pull request carries a Changeset. The generated [changelog](https://github.com/ParthJadhav/desktop-destroyer/blob/main/CHANGELOG.md)
