...
| Repository | `ParthJadhav/desktop-destroyer` |
...
- `npm view desktop-destroyer version` reports whether that exact version already exists.
...
2. Add a GitHub Actions publisher for `ParthJadhav/desktop-destroyer`, workflow `release.yml`,
   on the `main` branch.
