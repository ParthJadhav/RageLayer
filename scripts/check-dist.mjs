...
// Last refreshed after the performance-telemetry pass (per-subsystem frame
// breakdown, surface upload counters, GPU timer queries) grew the engine core
// by ~6 KiB.
const budgets = {
  "dist/index.js": { raw: 434 * 1024, gzip: 119 * 1024 },
  "dist/engine/index.js": { raw: 327 * 1024, gzip: 86 * 1024 },
  "dist/tools/index.js": { raw: 84 * 1024, gzip: 25 * 1024 },
  "dist/tools/heavy.js": { raw: 49 * 1024, gzip: 17 * 1024 },
  "dist/tools/advanced.js": { raw: 33 * 1024, gzip: 11 * 1024 },
  "dist/lazy/index.js": { raw: 123 * 1024, gzip: 37 * 1024 },
  "dist/sdk/index.js": { raw: 4 * 1024, gzip: 2 * 1024 },
  "dist/react/index.js": { raw: 441 * 1024, gzip: 121 * 1024 },
  "dist/vue/index.js": { raw: 440 * 1024, gzip: 120 * 1024 },
  "dist/svelte/index.js": { raw: 410 * 1024, gzip: 111 * 1024 },
  // The custom element carries the engine plus the default toolset, the same
  // as any other ready-made toolbar entry.
  "dist/element/index.js": { raw: 438 * 1024, gzip: 120 * 1024 },
  ...
  "dist/toolbar/index.js": { raw: 49 * 1024, gzip: 17 * 1024 },
};
